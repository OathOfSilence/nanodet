...
class BaseDataset(Dataset, metaclass=ABCMeta):
    ...
    Args:
        img_path (str | list[str]): image data folder(s) - single path or multiple paths
        ann_path (str | list[str]): annotation file path or folder(s) - single path or multiple paths
    ...
    def __init__(
        self,
        img_path: Union[str, Sequence[str]],
